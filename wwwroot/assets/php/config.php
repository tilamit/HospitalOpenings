...
(
   "TO_EMAIL"       => "recipient@email.com",  // PUT YOUR EMAIL HERE. THIS SHOULD BE AN EMAIL ON YOUR SERVER'S DOMAIN
   ...
   */
   ...
   "ENABLE_GMAIL"   => false,                     // TO USE GMAIL EMAIL SERVER SET VALUE TO: true
